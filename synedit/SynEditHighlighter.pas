...
type
  ...
  private
    ...
    { Local change: the kind of reserved word this attribute paints.
      LoadHighlighterAttri reads it to know which words belong to the
      attribute, SaveHighlighter to know which list to write. }
    fKind: Integer;
...
type
  ...
  private
    ...
    //### End Code Folding ###
    { Local change: fAttributes is declared last here, not first -- keep it
      after the code folding fields. }
