...
const
  { Local change: the whole cp1251 Russian range counts as letters --
    #$C0..#$FF plus #$A8 and #$B8. The western default leaves out #$D7
    and #$F7, which in cp1251 are letters too. }
